    ...
    <div className="min-h-screen bg-gray-800">
      ...
      <div className="mt-6 flex justify-end">
        <button
          ...
          className="flex items-center px-4 py-2 bg-primary hover:bg-primary/90 text-white font-medium rounded-lg transition-colors duration-200 shadow-sm hover:shadow"
        >
